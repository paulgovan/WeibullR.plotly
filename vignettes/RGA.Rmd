...
Start by loading `ReliaGrowR` and `WeibullR.plotly`
...
To run a Piecewise Weibull NHPP with Change Point Detection, first set up some cumulative time and failure data:
```{r}
times <- c(100, 200, 300, 400, 500, 600, 700, 800, 900, 1000)
failures <- c(1, 2, 1, 1, 1, 2, 3, 1, 2, 4)
```
